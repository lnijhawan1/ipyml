...
class SKLinearRegression(ModelGenerator):
    ...
    def create_model(self, *_):
        ...
        reg = LinearRegression(fit_intercept=self.values["Fit Intercept?"])
...
class SMOLS(ModelGenerator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.l1_weight = ipyw.FloatSlider(min=0, max=1, value=0.5)
        ...
        self.children = [
            ...
            ipyw.HTML(
                "Select weight for L1 param (If 0-Ridge Regression. If 1-Lasso Regression):"
            ),
            self.l1_weight,
            ipyw.HTML("Target:"),
