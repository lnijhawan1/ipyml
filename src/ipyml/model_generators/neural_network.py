...
from ..utils import HiddenLayers, TrainedModel
...
class NeuralNetwork(ModelGenerator):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.max_iteration = ipyw.IntSlider(
            min=1000, max=10000, description="Max Iter:"
        )
        self.activation = ipyw.Dropdown(
            options=["identity", "logistic", "tanh", "relu"],
            value="relu",
            description="Activation:",
        )
        self.solver = ipyw.Dropdown(
            options=["lbfgs", "sgd", "adam"], value="adam", description="Solver:"
        )
